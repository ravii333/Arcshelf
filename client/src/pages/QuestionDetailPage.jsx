  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header Section */}
        <div className="bg-gradient-to-br from-[#0b1f17] via-[#15322d] to-[#128c43] w-full mt-auto shadow-lg shadow-green-900/20 transition-all duration-500 rounded-xl p-8 mb-8 text-white">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="flex-1">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h1 className="text-4xl lg:text-5xl font-bold mb-2">{question.subject}</h1>
                  <p className="text-2xl text-green-100 font-semibold">{question.year}</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {[
                    ...
                    <span key={idx} className="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-white/20 backdrop-blur-sm">
            ...
            {question.fileUrl && (
              <div className="mt-8 lg:mt-0 lg:ml-8">
                <a
                  ...
                  className="inline-flex items-center px-8 py-4 bg-white text-green-700 font-bold rounded-xl shadow-xl hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-white/20 transition-all duration-300 transform hover:scale-105"
                >
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-center mb-6">
                <div className="w-14 h-14 bg-gradient-to-br from-[#0b1f17] via-[#15322d] to-[#128c43] rounded-xl flex items-center justify-center mr-4">
